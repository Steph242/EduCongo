        ...
        <nav className="hidden lg:flex items-center gap-2.5">
          {onOpenDevPanel && (
            <button
              ...
              className={`text-[12px] font-bold px-3 py-1.5 rounded-xl border transition-all flex items-center gap-1.5 cursor-pointer ${
          ...
          <button
            onClick={onOpenHelp}
            className="text-[12.5px] font-medium text-slate-300 hover:text-white px-2.5 py-1.5 rounded-lg hover:bg-white/[0.06] transition-all flex items-center gap-1 cursor-pointer"
          >
          ...
          <div className="flex items-center gap-1.5 bg-emerald-500/10 text-emerald-300 text-[11px] font-semibold px-2.5 py-1 rounded-full border border-emerald-500/25 backdrop-blur-md">
