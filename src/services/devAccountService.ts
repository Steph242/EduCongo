...
// Default Master Developer & Super Administrator Accounts
export const DEFAULT_DEVELOPER_ACCOUNTS: DeveloperAccount[] = [
  {
    id: 'DEV-SUPER-ADMIN-01',
    fullName: 'Steph ALONGO',
    email: 'steph.alongo@gmail.com',
    password: 'Verlaine92/Brealy95/',
    role: 'Super-Administrateur Système',
    department: 'MEPPSA - Direction Générale & Super-Administration EduCongo',
